...
@Component({
  ...
  template: `
    <div *ngIf="status" class="mt-4 animate-fade-in-down">
      
      <!-- ==================== 1. BLOCKED (PULSING & FLASHING RED) ==================== -->
      <div *ngIf="status === 'BLOCKED'" 
           class="relative overflow-hidden rounded-2xl border-2 border-red-400 bg-gradient-to-r from-red-50 via-rose-50 to-red-100/70 p-4 sm:p-5 shadow-lg shadow-red-500/10 animate-pulse-danger">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div class="flex items-start gap-3.5 min-w-0">
            <!-- Pulsing Beacon & Danger Icon -->
            <div class="relative flex-shrink-0 mt-0.5">
              <span class="absolute -inset-1 rounded-2xl bg-red-400 opacity-75 animate-ping"></span>
              <div class="relative flex h-11 w-11 items-center justify-center rounded-xl bg-red-600 text-white shadow-md shadow-red-600/30">
                <svg class="h-6 w-6 animate-pulse" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
            ...
            <div class="min-w-0">
              <div class="flex flex-wrap items-center gap-2 mb-1">
                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-black uppercase tracking-wider bg-red-600 text-white shadow-sm animate-pulse">
          ...
          <div *ngIf="clientId && showLink" class="flex-shrink-0 self-stretch sm:self-auto flex items-center">
            <a [routerLink]="['/home/client-conformity']" [queryParams]="{ id: clientId }"
               class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-red-600 hover:bg-red-700 active:bg-red-800 text-white text-xs font-bold shadow-md shadow-red-600/25 hover:shadow-lg transition-all duration-200">
      ...
      <div *ngIf="status === 'AML_REQUIRED'" 
           class="relative overflow-hidden rounded-2xl border border-amber-300 bg-gradient-to-r from-amber-50 via-yellow-50 to-orange-50/60 p-4 sm:p-5 shadow-sm animate-pulse-amber">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div class="flex items-start gap-3.5 min-w-0">
            <div class="relative flex-shrink-0 mt-0.5">
              <span class="absolute -inset-1 rounded-2xl bg-amber-400 opacity-60 animate-ping"></span>
              <div class="relative flex h-11 w-11 items-center justify-center rounded-xl bg-amber-500 text-white shadow-md shadow-amber-500/20">
            ...
            <div class="min-w-0">
              <div class="flex flex-wrap items-center gap-2 mb-1">
                <span class="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full text-xs font-black uppercase tracking-wider bg-amber-100 text-amber-900 border border-amber-300 animate-pulse">
          ...
          <div *ngIf="clientId && showLink" class="flex-shrink-0 self-stretch sm:self-auto flex items-center">
            <a [routerLink]="['/home/client-conformity']" [queryParams]="{ id: clientId }"
               class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-amber-600 hover:bg-amber-700 active:bg-amber-800 text-white text-xs font-bold shadow-sm transition-all">
      ...
      <div *ngIf="status === 'VERIFICATION_AML_REQUIRED'" 
           class="relative overflow-hidden rounded-2xl border border-sky-300 bg-gradient-to-r from-sky-50 via-blue-50 to-indigo-50/60 p-4 sm:p-5 shadow-sm animate-pulse-blue">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div class="flex items-start gap-3.5 min-w-0">
            <div class="relative flex-shrink-0 mt-0.5">
              <span class="absolute -inset-1 rounded-2xl bg-sky-400 opacity-60 animate-ping"></span>
              <div class="relative flex h-11 w-11 items-center justify-center rounded-xl bg-sky-600 text-white shadow-md shadow-sky-600/20">
                <svg class="h-6 w-6 animate-pulse" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="min-w-0">
              <div class="flex flex-wrap items-center gap-2 mb-1">
                <span class="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full text-xs font-black uppercase tracking-wider bg-sky-100 text-sky-900 border border-sky-300 animate-pulse">
          ...
          <div *ngIf="clientId && showLink" class="flex-shrink-0 self-stretch sm:self-auto flex items-center">
            <a [routerLink]="['/home/client-conformity']" [queryParams]="{ id: clientId }"
               class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-sky-600 hover:bg-sky-700 active:bg-sky-800 text-white text-xs font-bold shadow-sm transition-all">
      ...
      <div *ngIf="status === 'INDULGENCE_REQUIRED'" 
           class="relative overflow-hidden rounded-2xl border border-purple-300 bg-gradient-to-r from-purple-50 via-fuchsia-50 to-purple-100/60 p-4 sm:p-5 shadow-sm animate-pulse-purple">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div class="flex items-start gap-3.5 min-w-0">
            <div class="relative flex-shrink-0 mt-0.5">
              <span class="absolute -inset-1 rounded-2xl bg-purple-400 opacity-60 animate-ping"></span>
              <div class="relative flex h-11 w-11 items-center justify-center rounded-xl bg-purple-600 text-white shadow-md shadow-purple-600/20">
                <svg class="h-6 w-6 animate-pulse" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="min-w-0">
              <div class="flex flex-wrap items-center gap-2 mb-1">
                <span class="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full text-xs font-black uppercase tracking-wider bg-purple-100 text-purple-900 border border-purple-300 animate-pulse">
          ...
          <div *ngIf="clientId && showLink" class="flex-shrink-0 self-stretch sm:self-auto flex items-center">
            <a [routerLink]="['/home/client-conformity']" [queryParams]="{ id: clientId }"
               class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white text-xs font-bold shadow-sm transition-all">
      ...
      <div *ngIf="status === 'AML_VALIDATED' || status === 'VALIDATED'" 
        ...
        <div class="flex items-center justify-between gap-3">
          ...
          <div *ngIf="clientId && showLink" class="flex-shrink-0">
            <a [routerLink]="['/home/client-conformity']" [queryParams]="{ id: clientId }"
               class="text-xs font-bold text-emerald-700 hover:text-emerald-900 underline-offset-2 hover:underline transition-colors">
      ...
      <div *ngIf="status !== 'BLOCKED' && status !== 'AML_REQUIRED' && status !== 'VERIFICATION_AML_REQUIRED' && status !== 'INDULGENCE_REQUIRED' && status !== 'AML_VALIDATED' && status !== 'VALIDATED'"
           class="relative overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 p-4 shadow-sm animate-pulse-slate">
        <div class="flex items-center justify-between gap-3">
          <div class="flex items-center gap-3 min-w-0">
