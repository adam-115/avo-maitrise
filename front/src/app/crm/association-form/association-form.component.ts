...
import { ClientStatus, ClientTypeEnum, ContactPoint, Document, SecteurActivite, Association } from '../../appTypes';
...
export class AssociationFormComponent implements OnInit {
    ...
    constructor() {
        this.clientForm = this.fb.group({
            id: [null],
            type: [ClientTypeEnum.ASSOCIATION],
    ...
    onSubmit(): void {
        ...
        Promise.all(uploadPromises).then(() => {
            ...
            request$.subscribe({
                next: (client: any) => {
                    this.alertService.success(this.isEditMode ? 'Association modifiée' : 'Association créée');
